...
router.put("/game-id", auth, async (req, res) => {
    try {
        ...
        // Check if another admin already owns this Game ID
        ...
        // Check if a customer already owns this Game ID
        ...
        // Check existing GameApplication
        const existingApplication = await GameApplication.findOne({
            gameId
        });

        // Never allow admin to claim a customer-owned application
        if (
            existingApplication &&
        ...
        // Disable old Admin GameApplication
        ...
        // Existing admin application → activate it
        if (
            existingApplication &&
        ...
        // No existing application → create admin application
        else {
